...
<?php $__env->startSection('title'); ?> Vulnerability Disclosure Policy <?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Vulnerability Disclosure Policy</h4>
            </div><!-- end card header -->
            <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="live-preview">
                                            ...
                                            <form action="<?php echo e(route('disclosue.store')); ?>" method="POST" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\corporate\resources\views/backend/admin/contentmanagemnt/vulnerabilitydisclosuepolicy.blade.php ENDPATH**/ ?>