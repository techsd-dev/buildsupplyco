                    ...
                    <table class="cart-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="cart-product-price">₹<?php echo e($item->product->prd_price); ?></span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="cart-product-price">₹<?php echo e($item->product->prd_price * $item->quantity); ?></span>
                                </td>
                                <td>
                ...
                <div class="cart-box cart-total">
                    ...
                    <div class="cart-box-inner">
                        <table class="table">
                            <tr>
                                <td>SUB TOTAL:</td>
                                <td><span>₹<?php echo e($cartItems->sum(fn($item) => $item->product->prd_price * $item->quantity)); ?></span></td>
                            </tr>
                            <tr>
                                <td>GRAND TOTAL:</td>
                                <td>
                                    <span>
                                        ₹<?php echo e($cartItems->sum(fn($item) => $item->product->prd_price * $item->quantity) - (session('discount') ? session('discount') * $cartItems->sum(fn($item) => $item->product->prd_price * $item->quantity) : 0)); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\buildsupplyco\resources\views/frontend/pages/products/cart.blade.php ENDPATH**/ ?>