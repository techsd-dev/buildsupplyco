...
<div class="row">
    ...
    <form method="GET" action="<?php echo e(route('orders')); ?>" class="mb-4">
        <div class="row g-3 align-items-center">
            <div class="col-md-3">
                ...
                <select name="order_status" id="orderStatus" class="form-select">
                    ...
                    <option value="confirmed" <?php echo e(request('order_status') == 'confirmed' ? 'selected' : ''); ?>>Confirmed</option>
                    <option value="delivered" <?php echo e(request('order_status') == 'delivered' ? 'selected' : ''); ?>>Delivered</option>
            ...
            <div class="col-md-3">
                ...
                <select name="transaction_status" id="transactionStatus" class="form-select">
                    <option value="">All</option>
                    <option value="success" <?php echo e(request('transaction_status') == 'success' ? 'selected' : ''); ?>>Success</option>
                    <option value="failed" <?php echo e(request('transaction_status') == 'failed' ? 'selected' : ''); ?>>Failed</option>
                </select>
            </div>
            <div class="col-md-3">
        ...
        <div class="mt-3">
            ...
            <a href="<?php echo e(route('orders')); ?>" class="btn btn-secondary">Reset</a>
        </div>
    </form>
