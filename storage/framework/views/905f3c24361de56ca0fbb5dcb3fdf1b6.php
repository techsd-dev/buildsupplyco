        ...
        <div class="col-md-5 col-sm-6">
            <div class="card card-shadow">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('applyJob')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\buildsupplyco\resources\views/frontend/pages/careers/details.blade.php ENDPATH**/ ?>