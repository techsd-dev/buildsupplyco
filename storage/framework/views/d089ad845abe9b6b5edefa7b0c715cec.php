                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="customer_name"><?php echo e($row->name); ?></td> <!-- Brand name -->
                                    <td class="image"><img src="<?php echo e(url('public/uploads/brands/',$row->image)); ?>" height="50px" width="80px" alt=""></td>
                                    <td class="status">
                                        <span class="badge 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin.brands.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\buildsupplyco\resources\views/backend/admin/brands/index.blade.php ENDPATH**/ ?>