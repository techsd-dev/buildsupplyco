                                            ...
                                            <div class="row align-items-center m-0">
                                                <div class="col-lg-4 p-0">
                                                    <div class="product-thumb">
                                                        <a href="#"><img src="<?php echo e(asset('public/frontend/assets/images/products/latest/1.jpg')); ?>" alt="" /></a>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="product-single style-2">
                                            <div class="row align-items-center m-0">
                                                <div class="col-lg-4 p-0">
                                                    <div class="product-thumb">
                                                        <a href="#"><img src="<?php echo e(asset('public/frontend/assets/images/products/latest/2.jpg')); ?>" alt="" /></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 p-0">
                                                    <div class="product-title">
                                    ...
                                    <li>
                                        <div class="product-single style-2">
                                            <div class="row align-items-center m-0">
                                                <div class="col-lg-4 p-0">
                                                    <div class="product-thumb">
                                                        <a href="#"><img src="<?php echo e(asset('public/frontend/assets/images/products/latest/3.jpg')); ?>" alt="" /></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 p-0">
                                                    <div class="product-title">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\buildsupplypro\resources\views/frontend/pages/products/list.blade.php ENDPATH**/ ?>