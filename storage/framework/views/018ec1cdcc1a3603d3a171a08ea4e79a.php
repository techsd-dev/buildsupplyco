...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('public/build/libs/sweetalert2/sweetalert2.min.css')); ?>" rel="stylesheet" type="text/css" />
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('public/build/images/sweetalert2/success-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('public/build/images/sweetalert2/error-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('public/build/images/sweetalert2/warning-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('public/build/images/sweetalert2/join-community.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('public/build/images/sweetalert2/email-verify.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('public/build/images/sweetalert2/notification-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('public/build/js/pages/sweetalerts.init.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('public/public/build/js/app.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\corporate\resources\views/advance-ui-sweetalerts.blade.php ENDPATH**/ ?>