...
<script>
    $(document).ready(function() {
        $('#categoryForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('category.storeOrUpdate')); ?>",
                method: 'POST',
                data: formData,
                contentType: false,
                processData: false,
...
<!-- =============== Category section end============== --><?php /**PATH C:\xampp\htdocs\buildsupplypro\resources\views/backend/admin/categories/ajax.blade.php ENDPATH**/ ?>