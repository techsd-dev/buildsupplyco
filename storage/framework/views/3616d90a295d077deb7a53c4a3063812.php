                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt=""
                                                    src="<?php echo e(URL::asset('public/build/images/users/avatar-1.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item" data-id="2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt=""
                                                    src="<?php echo e(URL::asset('public/build/images/users/avatar-2.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item" data-id="3">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt=""
                                                    src="<?php echo e(URL::asset('public/build/images/users/avatar-3.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item" data-id="4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt=""
                                                    src="<?php echo e(URL::asset('public/build/images/users/avatar-4.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\corporate\resources\views/tables-listjs.blade.php ENDPATH**/ ?>