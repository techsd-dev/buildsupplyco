            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="careers">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('jobSeekers')); ?>" class="nav-link">Job Seekers List</a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="careers">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.faqs')); ?>" class="nav-link">Faqs</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="orders">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('orders')); ?>" class="nav-link">Orders</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="trasanctions">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('tr.history')); ?>" class="nav-link">Trasanctions History</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="contentManagement">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admn.about.us')); ?>" class="nav-link">About Us</a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="contentManagement">
                    ...
                    <div class="collapse menu-dropdown" id="contentManagement">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contact.us')); ?>" class="nav-link">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="contentManagement">
...
<!-- Left Sidebar End -->
<!-- Vertical Overlay-->
<div class="vertical-overlay"></div><?php /**PATH C:\xampp\htdocs\buildsupplyco\resources\views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>