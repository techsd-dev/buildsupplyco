                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ₹<?php echo e(number_format($item->product->prd_price ?? $item->product->prd_price, 2)); ?>

                                </td>
                                <td><?php echo e($item->quantity); ?></td>
                                <td>
                                    ₹<?php echo e(number_format(($item->product->prd_price ?? $item->product->prd_price) * $item->quantity, 2)); ?>
