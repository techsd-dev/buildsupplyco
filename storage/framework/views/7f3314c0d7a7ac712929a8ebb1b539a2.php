...
<div class="page-banner-area bg-1" style="background-image: url('<?php echo e(asset('public/uploads/about/' . $data->banner)); ?>');">
    <div class="container">
...
<div class="about-area mt-50">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <img class="img-100p" src="<?php echo e(asset('public/uploads/about/' . $data->image)); ?>" alt="" />
            </div>
            <div class="col-lg-6 mt-sm-30">
                <div id="accordion">
                    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card single-faq">
                        <div class="card-header faq-heading" id="heading<?php echo e($key); ?>">
                            <h5 class="mb-0">
                                <a href="#collapse<?php echo e($key); ?>" class="btn btn-link" data-toggle="collapse" aria-expanded="<?php echo e($key == 0 ? 'true' : 'false'); ?>" aria-controls="collapse<?php echo e($key); ?>">
                        ...
                        <div id="collapse<?php echo e($key); ?>" class="collapse <?php echo e($key == 0 ? 'show' : ''); ?>" aria-labelledby="heading<?php echo e($key); ?>" data-parent="#accordion">
                            <div class="card-body">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\buildsupplypro\resources\views/frontend/pages/aboutus.blade.php ENDPATH**/ ?>