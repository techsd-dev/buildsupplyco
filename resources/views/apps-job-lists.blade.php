    ...
    <div class="row">
        ...
        <div class="col-xxl-3">
            <div class="card job-list-view-card overflow-hidden" id="job-overview">
                <img src="{{ URL::asset('public/build/images/small/img-10.jpg') }}" alt="" id="cover-img"
                    class="img-fluid background object-fit-cover">
                <div class="card-body">
                    <div class="avatar-md mt-n5">
                        <div class="avatar-title bg-light rounded-circle">
                            <img src="{{ URL::asset('public/build/images/companies/img-7.png') }}" alt="" class="avatar-xs view-companylogo">
                        </div>
                    </div>
                    <div class="mt-3">
