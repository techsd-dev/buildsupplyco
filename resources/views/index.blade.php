                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            <img src="{{ URL::asset('public/build/images/products/img-1.png') }}" alt=""
                ...
                <div class="card h-100 rounded-0">
                    <div class="card-body p-0">
                        ...
                        <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                            <div class="card-body">
                                <img src="{{ URL::asset('public/build/images/giftbox.png') }}" alt="">
                                <div class="mt-4">
...
@section('script')
    ...
    <!-- dashboard init -->
    <script src="{{ URL::asset('public/build/js/pages/dashboard-ecommerce.init.js') }}"></script>
