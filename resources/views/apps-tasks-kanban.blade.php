...
@endsection
@section('css')
    <link href="{{ URL::asset('public/build/libs/dragula/dragula.min.css') }}" rel="stylesheet">
@endsection
@section('content')
                ...
                <div class="col-auto ms-sm-auto">
                    <div class="avatar-group" id="newMembar">
                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            ...
                            <img src="{{ URL::asset('public/build/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xs">
                        </a>
                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Frank">
                            <img src="{{ URL::asset('public/build/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xs">
                        </a>
                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                        ...
                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            ...
                            <img src="{{ URL::asset('public/build/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xs">
                        </a>
                        <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-placement="top" title="Herbert">
                            <img src="{{ URL::asset('public/build/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xs">
                        </a>
...
@endsection
@section('script')
    <script src="{{ URL::asset('public/build/libs/dragula/dragula.min.js') }}"></script>
    <script src="{{ URL::asset('public/build/libs/dom-autoscroller/dom-autoscroller.min.js') }}"></script>
    <script src="{{ URL::asset('public/build/js/pages/tasks-kanban.init.js') }}"></script>
