                ...
                <div class="col-xl-6">
                    <div class="card overflow-hidden">
                        <div class="card-body bg-marketplace d-flex">
                            ...
                            <img src="{{ URL::asset('public/build/images/bg-d.png') }}" alt="" class="img-fluid" />
                        </div>
                    </div>
                </div>
                <!--end col-->
                    ...
                    <div class="table-responsive table-card">
                        <div data-simplebar style="max-height: 350px;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('public/build/images/nft/img-01.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('public/build/images/nft/img-03.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ URL::asset('public/build/images/nft/img-05.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                                <h6 class="fs-14 mb-1">Timothy Smith</h6>
                            ...
                            <table class="table table-borderless align-middle">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('public/build/images/nft/img-02.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle">
                                                <div class="ms-3">
                                                    <a href="#!">
                        ...
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/svg/crypto-icons/btc.svg') }}" class="avatar-xxs me-2"
                                            alt="">48,568.025</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/svg/crypto-icons/ltc.svg') }}" class="avatar-xxs me-2"
                                            alt="">87,142.027</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/svg/crypto-icons/etc.svg') }}" class="avatar-xxs me-2"
                                            alt="">33,847.961</td>
                                    <td>
                                        <span class="text-success mb-0"><i
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/svg/crypto-icons/dash.svg') }}" class="avatar-xxs me-2"
                                            alt="">73,654.421</td>
                                    <td>
                                        <span class="text-success mb-0"><i
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/svg/crypto-icons/bnb.svg') }}" class="avatar-xxs me-2"
                                            alt="">66,742.077</td>
                                    <td>
                                        <span class="text-danger mb-0"><i
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/svg/crypto-icons/usdt.svg') }}" class="avatar-xxs me-2"
                                            alt="">34,736.209</td>
                                    <td>
                                        <span class="text-success mb-0"><i
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        <p class="mb-1"><img src="{{ URL::asset('public/build/images/flags/us.svg') }}" alt="" height="15"
                                class="rounded me-2"> United States <span class="float-end">34%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('public/build/images/flags/russia.svg') }}" alt="" height="15"
                                class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('public/build/images/flags/spain.svg') }}" alt="" height="15"
                                class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                        <p class="mb-1"><img src="{{ URL::asset('public/build/images/flags/italy.svg') }}" alt="" height="15"
                                class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                        <p class="mb-0"><img src="{{ URL::asset('public/build/images/flags/germany.svg') }}" alt="" height="15"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img src="{{ URL::asset('public/build/images/nft/img-03.jpg') }}" alt="" height="220"
                            ...
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img src="{{ URL::asset('public/build/images/nft/img-04.jpg') }}" alt="" height="220"
                                        class="object-fit-cover w-100" />
                                    <div
                                        class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                        <div class="flex-grow-1">
                            ...
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img src="{{ URL::asset('public/build/images/nft/img-06.jpg') }}" alt="" height="220"
                                        class="object-fit-cover w-100" />
                                    <div
                                        class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                        <div class="flex-grow-1">
