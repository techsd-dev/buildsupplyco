                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="position-relative home-img text-center mt-5 mt-lg-0">
                                ...
                                <img src="{{ URL::asset('public/build/images/job-profile2.png') }}" alt="" class="user-img">
                    ...
                    <div class="row align-items-center justify-content-lg-between justify-content-center gy-4">
                        <div class="col-lg-5 col-sm-7">
                            <div class="about-img-section mb-5 mb-lg-0 text-center">
                                ...
                                <img src="{{ URL::asset('public/build/images/about.jpg') }}" alt="" class="img-fluid mx-auto rounded-3" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-warning-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-3.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-primary-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-2.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-danger-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-4.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-success-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-9.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-info-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-1.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-success-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-7.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-info-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-8.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-warning-subtle rounded">
                                                <img src="{{ URL::asset('public/build/images/companies/img-5.png') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/small/img-8.jpg') }}" alt="" class="img-fluid rounded" />
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/small/img-6.jpg') }}" alt="" class="img-fluid rounded" />
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline fs-14 text-muted">
                                        <li class="list-inline-item">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/small/img-9.jpg') }}" alt="" class="img-fluid rounded" />
                                </div>
                                <div class="card-body">
                                    <ul class="list-inline fs-14 text-muted">
                                        <li class="list-inline-item">
