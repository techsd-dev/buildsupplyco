...
@section('css')
<link href="{{ URL::asset('public/build/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet">
@endsection
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td class="company">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{URL::asset('public/build/images/brands/slack.png')}}" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                            </div>
                                        ...
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <div class="avatar-lg p-1">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img src="{{URL::asset('public/build/images/users/multi-user.jpg')}}" id="companylogo-img" class="avatar-md h-auto rounded-circle object-fit-cover" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{{URL::asset('public/build/js/pages/job-application.init.js')}}"></script>
