                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('public/build/images/svg/crypto-icons/mkr.svg') }}" alt=""
                                                    class="avatar-xxs" />
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('public/build/images/svg/crypto-icons/yfi.svg') }}" alt=""
                                                    class="avatar-xxs" />
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('public/build/images/svg/crypto-icons/mln.svg') }}" alt=""
                                                    class="avatar-xxs" />
                                            </div>
