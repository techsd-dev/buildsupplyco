                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/eur.svg') }}" alt=""
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/gbp.svg') }}" alt=""
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/jpy.svg') }}" alt=""
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/xrp.svg') }}" alt=""
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/xpm.svg') }}" alt=""
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/ppt.svg') }}" alt=""
