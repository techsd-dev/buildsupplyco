                                    ...
                                    <tr>
                                        ...
                                        <td class="name">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img src="{{ URL::asset('public/build/images/users/avatar-10.jpg') }}"
...
@section('script')
    ...
    <script src="{{ URL::asset('public/build/js/pages/crm-contact.init.js') }}"></script>
