			...
			<div class="col-xl-10 col-lg-9 fix">
							...
							<div class="row product-carousel cv-visible">
								<div class="col-lg-3">
									...
									<div class="product-single">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('public/frontend/assets/images/products/1.jpg') }}" alt="" /></a>
								...
								<div class="col-lg-3">
									...
									<div class="product-single">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('public/frontend/assets/images/products/7.jpg') }}" alt="" /></a>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
										</div>
									...
									<div class="product-single">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('public/frontend/assets/images/products/8.jpg') }}" alt="" /></a>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
										</div>
				...
				<div class="row mt-40">
					<div class="col-xl-4 col-lg-6">
						<div class="banner-sm hover-effect">
							<img src="{{ asset('public/frontend/assets/images/banners/md/1.jpg') }}" alt="" />
							<div class="banner-info">
					...
					<div class="col-xl-4 col-lg-6 mt-sm-30">
						<div class="banner-sm hover-effect">
							<img src="{{ asset('public/frontend/assets/images/banners/md/2.jpg') }}" alt="" />
							<div class="banner-info">
								<div class="product-value">
									<span>$345.00</span>
									<del>$429.99</del>
					...
					<div class="col-xl-4 col-lg-6 d-none d-xl-block">
						<div class="banner-sm hover-effect">
							<img src="{{ asset('public/frontend/assets/images/banners/md/3.jpg') }}" alt="" />
							<div class="banner-info">
								<div class="product-value">
									<span>$345.00</span>
									<del>$429.99</del>
				...
				<div class="row product-carousel-fullwidth cv-visible">
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/14.jpg') }}" alt="" /></a>
								<div class="downsale"><span>-</span>$25</div>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
				...
				<div class="row product-carousel-fullwidth cv-visible">
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/shop/10.jpg') }}" alt="" /></a>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
							</div>
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/shop/11.jpg') }}" alt="" /></a>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
							</div>
				...
				<div class="row product-carousel-fullwidth cv-visible">
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/15.jpg') }}" alt="" /></a>
								<div class="downsale"><span>-</span>$25</div>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/16.jpg') }}" alt="" /></a>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
							</div>
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/17.jpg') }}" alt="" /></a>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
							</div>
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/18.jpg') }}" alt="" /></a>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
							</div>
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/19.jpg') }}" alt="" /></a>
								<div class="downsale"><span>-</span>$25</div>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
					...
					<div class="col-lg-3">
						<div class="product-single">
							...
							<div class="product-thumb">
								<a href="#"><img src="{{ asset('public/frontend/assets/images/products/20.jpg') }}" alt="" /></a>
								<div class="product-quick-view">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
								</div>
							</div>
				...
				<div class="sidebar-single">
					...
					<div class="row blog-carousels mt-30">
						<div class="col-lg-12">
							<div class="blog-carousel">
								<div class="blog-carousel-thumb">
									<a href="#"><img src="{{ asset('public/frontend/assets/images/blog/sm/1.jpg') }}" alt="" /></a>
								</div>
						...
						<div class="col-lg-12">
							<div class="blog-carousel">
								<div class="blog-carousel-thumb">
									<a href="#"><img src="{{ asset('public/frontend/assets/images/blog/sm/2.jpg') }}" alt="" /></a>
								</div>
								<div class="blog-carousel-desc">
									<small>22 Apr 2019</small>
									<h4><a href="#">A blender is a kitchen and laboratory appliance</a></h4>
						...
						<div class="col-lg-12">
							<div class="blog-carousel">
								<div class="blog-carousel-thumb">
									<a href="#"><img src="{{ asset('public/frontend/assets/images/blog/sm/3.jpg') }}" alt="" /></a>
								</div>
								<div class="blog-carousel-desc">
									<small>22 Apr 2019</small>
									<h4><a href="#">A blender is a kitchen and laboratory appliance</a></h4>
