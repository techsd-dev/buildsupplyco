	...
	<script src="{{ asset('public/frontend/assets/js/vendor/jquery-3.2.1.min.js') }}"></script>
	<!-- bootstra.min js -->
	<script src="{{ asset('public/frontend/assets/js/bootstrap.min.js') }}"></script>
	<!-- mmenu js -->
	<script src="{{ asset('public/frontend/assets/js/jquery.mmenu.js') }}"></script>
	<!-- easing js -->
	<script src="{{ asset('public/frontend/assets/js/jquery.easing.min.js') }}"></script>
	<!-- perfect-scrollbar js -->
	<script src="{{ asset('public/frontend/assets/js/perfect-scrollbar.min.js') }}"></script>
	<!---slick-js-->
	<script src="{{ asset('public/frontend/assets/js/slick.min.js') }}"></script>
	<!---letteranimation-js-->
	<script src="{{ asset('public/frontend/assets/js/letteranimation.min.js') }}"></script>
	<!-- jquery-ui js -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="product-details-thumb" id="">
                            <img src="{{ asset('public/frontend/assets/images/products/default.jpg') }}" alt="Product Image" id="productImage" />
                        </div>
                    </div>
                    <div class="col-lg-8">
