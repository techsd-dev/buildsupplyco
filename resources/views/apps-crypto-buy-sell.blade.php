                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('public/build/images/svg/crypto-icons/dot.svg') }}" alt=""
                                        class="avatar-xxs me-2">
...
@endsection
@section('script')
    <script src="{{ URL::asset('public/build/libs/list.js/list.min.js') }}"></script>
    <script src="{{ URL::asset('public/build/libs/list.pagination.js/list.pagination.min.js') }}"></script>
    <script src="{{ URL::asset('public/public/build/libs/apexcharts/apexcharts.min.js') }}"></script>

    <script src="{{ URL::asset('public/build/js/pages/crypto-buy-sell.init.js') }}"></script>
