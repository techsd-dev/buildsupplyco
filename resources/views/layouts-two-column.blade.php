                        ...
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('public/build/images/users/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('public/build/images/users/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('public/build/images/users/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('public/build/images/users/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('public/build/images/users/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                        ...
                                        <div class="ctext-wrap">
                                            <div class="message-img mb-0">
                                                <div class="message-img-list">
                                                    <div>
                                                        <a class="popup-img d-inline-block"
                                                            href="{{ URL::asset('public/build/images/small/img-1.jpg') }}">
                                                ...
                                                <div class="message-img-list">
                                                    <div>
                                                        <a class="popup-img d-inline-block"
                                                            href="{{ URL::asset('public/build/images/small/img-2.jpg') }}">
