                                    ...
                                    <div class="col-md-auto">
                                        <div class="avatar-md">
                                            <div class="avatar-title bg-white rounded-circle">
                                                <img src="{{ URL::asset('public/build/images/brands/slack.png') }}" alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md">
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-sm mb-4">
                                <div class="avatar-title bg-secondary-subtle rounded">
                                    <img src="{{ URL::asset('public/build/images/companies/img-1.png') }}" alt="" class="avatar-xxs" />
                                </div>
                            </div>
                            <a href="#!">
                                <h5>Web designer</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-sm mb-4">
                                <div class="avatar-title bg-info-subtle rounded">
                                    <img src="{{ URL::asset('public/build/images/companies/img-2.png') }}" alt="" class="avatar-xxs" />
                                </div>
                            </div>
                            <a href="#!">
                        ...
                        <div class="card-body">
                            ...
                            <div class="avatar-sm mb-4">
                                <div class="avatar-title bg-warning-subtle rounded">
                                    <img src="{{ URL::asset('public/build/images/companies/img-3.png') }}" alt="" class="avatar-xxs" />
                                </div>
                            </div>
                            <a href="#!">
