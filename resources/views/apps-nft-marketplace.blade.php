...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-1 mb-3">
                                <div class="col-lg-6">
                                    <img src="{{ URL::asset('public/build/images/nft/img-05.jpg') }}" alt="" class="img-fluid rounded">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <img src="{{ URL::asset('public/build/images/nft/img-04.jpg') }}" alt="" class="img-fluid rounded">
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-1 mb-3">
                                <div class="col-lg-6">
                                    <img src="{{ URL::asset('public/build/images/nft/img-06.jpg') }}" alt="" class="img-fluid rounded">
                                ...
                                <div class="col-lg-6">
                                    <img src="https://img.themesbrand.com/velzon/images/img-5.gif" alt=""
                                        class="img-fluid rounded mb-1">
                                    <img src="{{ URL::asset('public/build/images/nft/img-03.jpg') }}" alt="" class="img-fluid rounded">
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-1 mb-3">
                                <div class="col-lg-6">
                                    <img src="{{ URL::asset('public/build/images/nft/img-02.jpg') }}" alt="" class="img-fluid rounded">
                                ...
                                <div class="col-lg-6">
                                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                                        class="img-fluid rounded mb-1">
                                    <img src="{{ URL::asset('public/build/images/nft/img-01.jpg') }}" alt="" class="img-fluid rounded">
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            ...
            <div class="card explore-box">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ URL::asset('public/build/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                    ...
                    <div class="explore-place-bid-img overflow-hidden rounded">
                        <img src="{{ URL::asset('public/build/images/nft/img-05.jpg') }}" alt="" class="img-fluid explore-img">
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ URL::asset('public/build/images/users/avatar-9.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                        <div class="ms-2 flex-grow-1">
                    ...
                    <div class="explore-place-bid-img overflow-hidden rounded">
                        <img src="{{ URL::asset('public/build/images/nft/img-03.jpg') }}" alt="" class="img-fluid explore-img">
                        <div class="bg-overlay"></div>
                        <div class="place-bid-btn">
                            <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                                Place Bid</a>
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ URL::asset('public/build/images/users/avatar-10.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                        <div class="ms-2 flex-grow-1">
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <img src="{{ URL::asset('public/build/images/users/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                        <div class="ms-2 flex-grow-1">
                    ...
                    <div class="explore-place-bid-img overflow-hidden rounded">
                        <img src="{{ URL::asset('public/build/images/nft/img-06.jpg') }}" alt="" class="img-fluid explore-img">
                        <div class="bg-overlay"></div>
                        <div class="place-bid-btn">
                            <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                                Place Bid</a>
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="explore-place-bid-img">
                    <img src="{{ URL::asset('public/build/images/nft/img-02.jpg') }}" alt="" class="card-img-top explore-img" />
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                            Place Bid</a>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="explore-place-bid-img">
                    <img src="{{ URL::asset('public/build/images/nft/img-04.jpg') }}" alt="" class="card-img-top explore-img" />
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                            Place Bid</a>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="explore-place-bid-img">
                    <img src="{{ URL::asset('public/build/images/nft/img-01.jpg') }}" alt="" class="card-img-top explore-img" />
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                            Place Bid</a>
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('public/build/images/nft/img-03.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="{{ URL::asset('public/build/images/nft/img-04.jpg') }}" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('public/build/images/nft/img-01.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
                    <img src="{{ URL::asset('public/build/images/nft/img-06.jpg') }}" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('public/build/images/nft/img-05.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('public/build/images/nft/img-02.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
