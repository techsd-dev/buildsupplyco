                    ...
                    <div>
                        ...
                        <div class="avatar-group">
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                ...
                                <div class="avatar-xs">
                                    <img src="{{ URL::asset('public/build/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle img-fluid">
                                </div>
                            </a>
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                ...
                                <div class="avatar-xs">
                                    <img src="{{ URL::asset('public/build/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle img-fluid">
                                </div>
                            </a>
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
