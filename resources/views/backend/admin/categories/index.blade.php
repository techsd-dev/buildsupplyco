                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="customer_name">{{ $row->name }}</td> <!-- Category name -->
                                    <td class="image"><img src="{{ url('public/uploads/categories/',$row->images) }}" height="50px" width="80px" alt=""></td>
                                    <td class="status">
                                        <span class="badge 
...
@section('script')
@endsection
@include('backend.admin.categories.ajax')