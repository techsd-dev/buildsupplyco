                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="image">
                                        <img src="{{ $row->image ? url('public/uploads/banners/' . $row->image) : asset('default-image.jpg') }}" height="50px" width="70px">
                                    </td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <div class="remove">
                                                <a href="{{ route('banner.delete', $row->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to delete this?')">Remove</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    $(document).ready(function() {
        $('#bannerForm').on('submit', function(e) {
            ...
            if ($('#bannerId').val() === "") {
                ...
                actionUrl = "{{ route('banner.update', '') }}/" + bannerId;
                method = 'POST';
            }
