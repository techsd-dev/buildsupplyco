                                        ...
                                        <div class="live-preview">
                                            ...
                                            <form action="{{ route('privacy.policy.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-floating">
                                                            <input type="text" name="title" class="form-control" value="{{ $privacy->title ?? '' }}" id="productNameInput">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-floating">
                                                            <textarea name="description" class="form-control" id="descriptionInput1" placeholder="Enter  description">{!! $privacy->description ?? '' !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br>
