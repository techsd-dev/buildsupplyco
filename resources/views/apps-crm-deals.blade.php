                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('public/build/images/brands/github.png') }}" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated5"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('public/build/images/brands/mail_chimp.png') }}" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified3"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('public/build/images/brands/dribbble.png') }}" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('public/build/images/companies/img-6.png') }}" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('public/build/images/brands/slack.png') }}" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
...
@endsection
@section('script')
    <script src="{{ URL::asset('public/build/libs/cleave.js/cleave.min.js') }}"></script>
    <script src="{{ URL::asset('public/build/js/pages/crm-deals.init.js') }}"></script>
