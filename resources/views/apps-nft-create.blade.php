...
@section('css')
<!-- Filepond css -->
<link href="{{ URL::asset('public/build/libs/filepond/filepond.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ URL::asset('public/build/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
@section('script')
   <!-- filepond js -->
<script src="{{ URL::asset('public/build/libs/filepond/filepond.min.js') }}"></script>
<script src="{{ URL::asset('public/build/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.js') }}"></script>
<script src="{{ URL::asset('public/build/libs/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js') }}"></script>
<script src="{{ URL::asset('public/build/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js') }}"></script>
<script src="{{ URL::asset('public/build/libs/filepond-plugin-file-encode/filepond-plugin-file-encode.min.js') }}"></script>
<!--nft create init js-->
<script src="{{ URL::asset('public/build/js/pages/apps-nft-create.init.js') }}"></script>
