                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-warning-subtle rounded p-2">
                                        <img src="{{ URL::asset('public/build/images/brands/slack.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-info-subtle rounded p-2">
                                        <img src="{{ URL::asset('public/build/images/brands/dropbox.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-secondary-subtle rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('public/build/images/brands/dribbble.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('public/build/images/brands/slack.png') }}" alt="" height="32">
                        </div>
                    </div>
                    <div class="py-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-primary-subtle rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('public/build/images/brands/dropbox.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('public/build/images/brands/mail_chimp.png') }}" alt="" height="32">
                        </div>
                    </div>
