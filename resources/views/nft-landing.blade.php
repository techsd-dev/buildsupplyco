                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('public/build/images/nft/wallet/metamask.png') }}" alt="" height="55"
                                        class="mb-3 pb-2">
                                    <h5>Metamask</h5>
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('public/build/images/nft/wallet/coinbase.png') }}" alt="" height="55"
                                        class="mb-3 pb-2">
                        ...
                        <div class="col-lg-4">
                            <div class="card text-center border shadow-none">
                                <div class="card-body py-5 px-4">
                                    <img src="{{ URL::asset('public/build/images/nft/wallet/binance.png') }}" alt="" height="55"
                                        class="mb-3 pb-2">
                                    <h5>Binance</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/nft/wallet.png') }}" alt="" class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/nft/money.png') }}" alt="" class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/nft/add.png') }}" alt="" class="avatar-sm">
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <img src="{{ URL::asset('public/build/images/nft/sell.png') }}" alt="" class="avatar-sm">
                    ...
                    <div class="row">
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="explore-place-bid-img overflow-hidden rounded">
                                        <img src="{{ URL::asset('public/build/images/nft/img-05.jpg') }}" alt="" class="explore-img w-100">
                                        <div class="bg-overlay"></div>
                                        <div class="place-bid-btn">
                                            <a href="#!" class="btn btn-success"><i
                                                    class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                        ...
                        <div class="col-lg-4">
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="{{ URL::asset('public/build/images/users/avatar-9.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle">
                                        <div class="ms-2 flex-grow-1">
                                            <a href="#!">
                                    ...
                                    <div class="explore-place-bid-img overflow-hidden rounded">
                                        <img src="{{ URL::asset('public/build/images/nft/img-03.jpg') }}" alt="" class="explore-img w-100">
                                        <div class="bg-overlay"></div>
                                        <div class="place-bid-btn">
                                            <a href="#!" class="btn btn-success"><i
                                                    class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
