...
@endsection
@section('css')
    <link href="{{ URL::asset('public/build/libs/nouislider/nouislider.min.css') }}" rel="stylesheet">
...
@section('script')
    ...
    <script src="{{ URL::asset('public/build/js/pages/ecommerce-product-list.init.js') }}"></script>
    <script src="{{ URL::asset('public/public/public/build/js/app.js') }}"></script>
@endsection
