                        ...
                        <table class="table table-bordered table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/users/avatar-1.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                        <a href="#javascript: void(0);" class="text-body fw-medium">Donald Risher</a>
                                    </td>
                                    <td>$96k</td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ URL::asset('public/build/images/users/avatar-2.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td><img src="{{ URL::asset('public/build/images/users/avatar-7.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Raitech Soft</td>
                                    <td><img src="{{ URL::asset('public/build/images/users/avatar-4.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
