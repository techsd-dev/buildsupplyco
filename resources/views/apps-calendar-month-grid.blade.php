...
@endsection
@section('script')
    <script src="{{ URL::asset('public/build/libs/fullcalendar/index.global.min.js') }}"></script>
    <script src="{{ URL::asset('public/build/js/pages/calendar-month-grid.init.js') }}"></script>
