...
@section('css')
    <link href="{{ URL::asset('public/build/libs/aos/aos.css') }}" rel="stylesheet">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-sm-10 col-lg-8">
                                                <div data-aos="fade-up">
                                                    <img src="{{ URL::asset('public/build/images/mac-img.png') }}" alt="Mac Image"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('public/build/libs/aos/aos.js') }}"></script>
    <script src="{{ URL::asset('public/build/libs/prismjs/prism.js') }}"></script>
    <script src="{{ URL::asset('public/build/js/pages/animation-aos.init.js') }}"></script>
